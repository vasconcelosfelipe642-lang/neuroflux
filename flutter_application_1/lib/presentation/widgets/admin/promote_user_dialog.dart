...
class PromoteUserDialog extends StatelessWidget {
  ...
  static Future<bool?> show(
    ...
    return showDialog<bool>(
      ...
      builder: (dialogContext) => PromoteUserDialog(
        user: user,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(AppStrings.adminPromoteTitle, style: AppTextStyles.adminModalTitle),
            const SizedBox(height: AppSizes.lg),
            Container(
            ...
            const SizedBox(height: AppSizes.lg),
            Text(
              AppStrings.adminPromoteWarning(user.nome.split(' ').first),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text(AppStrings.adminPromoteConfirm),
              ),
            ),
